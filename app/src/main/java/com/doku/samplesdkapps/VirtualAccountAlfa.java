...
public class VirtualAccountAlfa extends AppCompatActivity {
    ...
    private class VirtualAccountPayment extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(VirtualAccountAlfa.this);
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            try {
                ...
                String conResult = ApiConnection.httpsConnection(VirtualAccountAlfa.this, Constants.URL_REQUEST_VACODE, data);
            ...
            if (json != null) {
                ...
                try {
                    if (json.getString("res_response_code").equalsIgnoreCase("0000") && json != null) {
                        Intent intent = new Intent(getApplicationContext(), VAResultAlfa.class);
